...
const Heroe = () => {
    return (
        <div className='w-full lg:min-h-screen min-h-fit py-44 bg-secondary bg-gradient-to-r from-primary from-60% to-secondary to-40% sm:px-10 px-4  md:flex hidden'>
            <div className=' md:flex hidden flex-row items-center justify-between max-w-[1440px] mx-auto'>
