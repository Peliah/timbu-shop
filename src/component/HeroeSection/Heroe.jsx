...
const Heroe = () => {
    return (
        <div className='w-full lg:min-h-screen min-h-[70vh] bg-secondary bg-gradient-to-r from-primary from-60% to-secondary to-40% md:flex hidden flex-row items-center justify-between lg:px-36 sm:px-10 px-4 '>
